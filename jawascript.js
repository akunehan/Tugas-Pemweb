/* ══════════════════════════════════════════
   OTWin – jawascript.js
   Fitur: Navbar scroll, Reveal, Toast,
          Login, Register, Booking Tiket
══════════════════════════════════════════ */
...
// Tombol beralih antar modal (Login ↔ Register)
...
function handleBooking() {
  ...
  if (!tanggal) {
    showToast('⚠️ Pilih tanggal pemberangkatan!');
    return;
  }
